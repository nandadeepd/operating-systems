...
-----------------------------  FrameManager  ---------------------------------
  ...
  behavior FrameManager
      ...
      --  When threads request new frames, they are allotted based on availability. 
      --  If frames are not available, they are made to wait based on a condition
      --  Its written in a monitor style 
      ...
      --
      --  Threads return the frames after their use and signal waiting threads. 
      --  
      --
