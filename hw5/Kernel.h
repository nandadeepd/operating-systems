header Kernel
  ...
  var
    ...
    hThreadManager: HoareThreadManager
  ...
  functions
    ...
    ---- Adding this based on the Handout ----------
    InitFirstProcess()
    ---- End of function prototype added for p5 ------
